                ...
                <div class="sidebar">
                    <div class="sidebar-wrapper">
                        <div class="logo">
                            ...
                            <a href="./dashboard.php" class="active simple-text logo-normal">
                                Kampusku
                            </a>
                        </div>
                        <ul class="nav">
                                            ...
                                            <table class="table ms-4">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col"><a href="./actuser.php?aksi=new" class="btn btn-primary"><i class="fa-solid fa-user-plus"></i>&nbsp;Tambah</a></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $h["email"] ?></td>
                                                            <td><?= $h["passkey"] ?></td>
                                                            <td><a href="./actuser.php?aksi=edit&p1=<?= $h["iduser"] ?>" class="btn btn-warning"><i class="fa-solid fa-user-pen"></i>&nbsp;Edit</a>
                                                                <a href="./actuser.php?aksi=del&p1=<?= $h["iduser"] ?>" class="btn btn-danger"><i class="fa-solid fa-user-xmark"></i>&nbsp;Del</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
