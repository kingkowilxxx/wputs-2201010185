              ...
              <div class="col-12">
                <div class="card card-chart">
                  ...
                  <div class="card-body" style="height:200px">
                    <div class="container">
                        <p class="m-auto m-4">Selamat datang di website kampus IR. MERTA <p> Website ini dikembangkan oleh : </p> <br>
                        <h4>Nama : I Komang Widyanata Merta</h4>
                         <h4>NIM : 2201010185</h4>
                         <h4>Kls : M</h4>
