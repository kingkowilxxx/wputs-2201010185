                ...
                <div class="card-body">
                    <div class="chart-area h-auto">
                        <div class="container konten">
                            <?php
                            $id_dosen = $_GET["p1"];
                            $sql = "SELECT * FROM tbDSN tu WHERE id_dosen='$id_dosen';";
                            ...
                            ?>
                                ...
                                <form method="POST" action="./datadsn.php">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="txNAMA" class="form-control" id="floatingInput" placeholder="Nama Lengkap" value="<?= $h["nama_dosen"] ?>">
